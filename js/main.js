      ...
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14 sm:h-16">
          ...
          <div class="nav-links hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <a href="/gradients" class="text-sm font-medium hover:text-emerald-500 transition-colors ${currentPage === 'index.html' && window.location.pathname.includes('/gradients') ? 'text-emerald-500' : ''}">Gradients</a>
