      ...
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14 sm:h-12">
          ...
          <div class="flex items-center gap-2 sm:gap-4">
            ...
            <a href="/pages/tools/palette.html" class="hidden sm:flex btn-primary text-sm">
    ...
    <div class="mobile-menu fixed inset-0 z-40 bg-white dark:bg-slate-900 transform transition-transform duration-300 translate-x-full md:hidden pt-16">
      <div class="flex flex-col gap-4 p-6 h-full overflow-y-auto">
        ...
        <div class="mt-auto pb-8">
          <a href="/pages/tools/palette.html" class="btn-primary text-center mt-4 w-full justify-center">
            <i class="fas fa-palette"></i>
            Create Free Palette
          </a>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <li><a href="/pages/tools/palette.html" class="hover:text-emerald-500 transition-colors">Palette Generator</a></li>
              <li><a href="/pages/tools/gradient.html" class="hover:text-emerald-500 transition-colors">Gradient Builder</a></li>
              <li><a href="/pages/tools/converter.html" class="hover:text-emerald-500 transition-colors">Color Converter</a></li>
              <li><a href="/pages/palettes/pastel-color-palettes.html" class="hover:text-emerald-500 transition-colors">Browse Palettes</a></li>
            </ul>
          </div>
